...
public class RippleEffect : MonoBehaviour
{
    ...
    public Vector2 spawnPos = new Vector2(0.5f, 0.5f);
    ...
    void UpdateShaderParameters()
    {
        ...
        {
            material.SetVector("_Drop" + (i+1), droplets[i].MakeShaderParameter(cam.aspect));
        }
    ...
    public void Emit()
    {
        droplets[dropCount++ % droplets.Length].Reset(spawnPos);
    }
