Shader "Hidden/Ripple Effect"
{
    Properties
    {
        ...
        _Drop1("Drop 1", Vector) = (0.46, 0.5, 0, 0)
        _Drop2("Drop 2", Vector) = (0.47, 0.5, 0, 0)
        _Drop3("Drop 3", Vector) = (0.48, 0.5, 0, 0)
		_Drop4("Drop 4", Vector) = (0.49, 0.5, 0, 0)
		_Drop5("Drop 5", Vector) = (0.50, 0.5, 0, 0)
		_Drop6("Drop 6", Vector) = (0.51, 0.5, 0, 0)
		_Drop7("Drop 7", Vector) = (0.52, 0.5, 0, 0)
		_Drop8("Drop 8", Vector) = (0.53, 0.5, 0, 0)
		_Drop9("Drop 9", Vector) = (0.54, 0.5, 0, 0)
